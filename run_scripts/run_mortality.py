...
train_data = pd.read_csv("../../mimic/processed_data/mortality_tab_train.csv")
...
val_data = pd.read_csv("../../mimic/processed_data/mortality_tab_val.csv")
...
test_data = pd.read_csv("../../mimic/processed_data/mortality_tab_test.csv")
...
with open("../task_params.yaml", 'r') as f:
    model_params = yaml.safe_load(f)["mortality"][args.model]
    
# Read in best hpo params
with open(f"../hpo/mortality/best_configs/{args.model}_mortality_params.yaml", 'r') as f:
...
if args.model == "gbt":
    ...
    score_df.to_csv(f"../results/mortality.csv", mode='a', index=False, header=False)
