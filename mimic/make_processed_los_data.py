...
train_X_df.to_csv("processed_data/los_tab_train.csv", index=False)
val_X_df.to_csv("processed_data/los_tab_val.csv", index=False)
test_X_df.to_csv("processed_data/los_tab_test.csv", index=False)